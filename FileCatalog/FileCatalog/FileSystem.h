...
* ====================
* ver 2.6 : 08 Feb 15
* -	added function findString to find searchtext in a file and
*	return a set of positions it has been found in
* ver 2.5 : 02 Feb 15
...
namespace FileCatalog
{
	...
	public:
		...
		std::set<int> findString(std::string searchtext, bool keepNewLines = false);
